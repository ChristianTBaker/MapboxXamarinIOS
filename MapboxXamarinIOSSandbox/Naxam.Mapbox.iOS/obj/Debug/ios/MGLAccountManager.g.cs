...
namespace Mapbox {
	...
	public unsafe partial class MGLAccountManager : NSObject {
		...
		public static string AccessToken {
			[Export ("accessToken")]
			get {
				return NSString.FromHandle (global::ApiDefinitions.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("accessToken")));
			}
			...
			set {
				...
				global::ApiDefinitions.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setAccessToken:"), nsvalue);
